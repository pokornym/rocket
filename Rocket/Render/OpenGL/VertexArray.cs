...
namespace Rocket.Render.OpenGL {
	internal class VertexArray : BoundElement, IVertexCollection, IVertexRenderer {
	...
	internal class VertexArray<TVertex> : VertexArray, IEnumerable<TVertex> where TVertex : struct {
